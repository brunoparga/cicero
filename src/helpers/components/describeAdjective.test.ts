...
const necesse = { lemma: 'necesse', properties: { indeclinable: true } } as Word;
const bonus = {
  lemma: 'bonus',
  properties: {
    masculineGenitive: '-ī',
...
it('describes Type I adjectives', () => {
  const description = 'Adjective: masculine bonus, -ī / feminine bona, -ae / neuter bonum, -ī';
  expect(describeAdjective(bonus)).toEqual(description);
});

it('describes syncopated Type I adjectives', () => {
  const description = 'Adjective: masculine āter, -trī / feminine -tra / neuter -trum';
  expect(describeAdjective(ater)).toEqual(description);
});

it('describes three-form Type II adjectives', () => {
  const description = 'Adjective: masculine celer / feminine -ris / neuter -e, genitive -is';
  expect(describeAdjective(celer)).toEqual(description);
});

it('describes two-form Type II adjectives', () => {
  const description = 'Adjective: masculine, feminine viridis / neuter -e, genitive -is';
